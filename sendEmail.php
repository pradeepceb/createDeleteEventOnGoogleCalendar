...
<!--
window.document.write ('<h2><span style="color: #ff0000;">There was an error in your submission please be sure to fill out all the required fields. <br>-Thank You</span></h2><div style="width:100%; text-align: center;"><a href="'+(window.location="index.php")+'">Click Here to Start Over</a></div>');
//-->
</script> 
<?php
        }
...
<?php
	...
	$location = $_POST['location'];
		...
		$response = '<form id="captcha_form" action="http://sooryalaya.com/booking/booking.php?cal=court1" method="post" name="booking"><fieldset>
